 ...
 * Compile with:
 *
 * gcc -fPIC -ffunction-sections -fdata-sections -m32 -march=pentium4 -mfpmath=sse -mstackrealign frida-core-example.c -o frida-core-example -L. -lfrida-core -ldl -lm -latomic -lrt -lresolv -pthread -fuse-ld=gold -Wl,--export-dynamic,--icf=all,--gc-sections,-z,noexecstack -static-libgcc
 *
